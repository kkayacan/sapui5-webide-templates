sap.ui.define([
	"sap/ui/test/Opa5",
	"com/template/master-detail/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("com.template.master-detail.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "com.template.master-detail",
					async: true
				},
				hash: oOptions.hash,
