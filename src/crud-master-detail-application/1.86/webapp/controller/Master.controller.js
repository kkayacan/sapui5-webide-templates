/*global history */
sap.ui.define([
	"com/template/crud-master-detail/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"com/template/crud-master-detail/model/formatter",
	"sap/m/MessageBox",
	"com/template/crud-master-detail/model/grouper",
	...
	return BaseController.extend("com.template.crud-master-detail.controller.Master", {
		...
		onOpenViewSettings: function () {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.template.crud-master-detail.view.ViewSettingsDialog", this);
