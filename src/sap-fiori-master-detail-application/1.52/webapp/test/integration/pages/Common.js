sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/template/master-detail/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.template.master-detail.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/template/master-detail/localService/mockserver"], function (mockserver) {
