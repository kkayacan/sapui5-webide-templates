sap.ui.define([
	...
	return BaseObject.extend("com.template.crud-master-detail.model.GroupSortState", {
		 ...
		 * @class
		 * @public
		 * @alias com.template.crud-master-detail.model.GroupSortState
		 */
		...
		/**
		 * Sorts by Description, or by Price
		 *
